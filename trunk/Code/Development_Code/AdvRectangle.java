 ...
 *
 */
public class AdvRectangle extends TwoPointShape implements Serializable
{
	...
	public void draw(Graphics g)
	{
	    ...
	    else 
	    {
	      ...
	      shapeHeight = (int)(this.origin.y-this.end.y)+1;
   	    ...
   	    /* Draw the outline of a AdvRectangle on the graphics */
   		...
   		/* Draw the solid shape of a AdvRectangle on the graphics */
   		else {
	   		g.fillRect(
					shapeX, 
					shapeY, 
	...
	public void drawHighlightBoxes(Graphics g) 
	{
		...
		/* Draw a small AdvRectangle at each corner */
	...
	/**
	 * Determine if the interior area of a AdvRectangle is selected.
	 */
	...
	/**
	 * Determine if the exterior area of a AdvRectangle is selected.
	 */
